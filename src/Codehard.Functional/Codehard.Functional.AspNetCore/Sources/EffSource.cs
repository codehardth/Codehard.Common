...
internal static class EffSource
{
    public static string FileName = "EffectExtensions.g.cs";
    ...
    public static string Generate()
    {
        ...
        sb.AppendLine();
        sb.AppendLine("public static class EffectExtensions");
        sb.AppendLine("{");
        ...
        // Map fail
        sb.AppendLine(
            "    public static Eff<A> MapFailToActionResult<A>(");
        sb.AppendLine(
            "        this Eff<A> ma,");
        sb.AppendLine(
        ...
        foreach (var statusCode in statusCodes)
        {
            sb.AppendLine();
            sb.AppendLine(
                $"    public static Eff<A> MapFailTo{statusCode}<A>(");
            sb.AppendLine(
                "        this Eff<A> ma,");
            sb.AppendLine(
                "        Option<string> errorCode = default,");
        ...
        foreach (var statusCode in statusCodes)
        {
            sb.AppendLine();
            sb.AppendLine(
                $"    public static Eff<A> GuardWith{statusCode}<A>(");
            sb.AppendLine(
        ...
        foreach (var statusCode in statusCodes)
        {
            sb.AppendLine();
            sb.AppendLine(
                $"    public static Eff<A> MapNoneTo{statusCode}<A>(this Eff<Option<A>> ma, string message = \"\")");
            sb.AppendLine(
                $"        => ma.Bind(opt => opt.ToEffWithFailTo{statusCode}(message));");
        }
